...
@property (weak) IBOutlet UIButton  *powerButton;

@property (unsafe_unretained) IBOutlet UITextView *logView;
...
- (IBAction)powerSwitch:(id)sender
{
    if (CBPeripheralManagerStatePoweredOn == _manager.state &&
        ...
        [_powerButton setTitle:@"Power Off"
        ...
        [_powerButton setTitle:@"Power On"
                      forState:UIControlStateNormal];
